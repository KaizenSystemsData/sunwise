...
<body>
  ...
  <!-- Navbar start -->
  <nav class="navbar navbar-expand-lg bg-body-tertiary p-3 m-0 border-0 bd-example m-0 border-0">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo" class="w-25"></a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="admission-guidance.html">Admission Guidance</a></li>
              <li><a class="dropdown-item" href="career-counseling.html">Career Counseling</a></li>
              <li><a class="dropdown-item" href="find-your-course.html">Find Your Course</a></li>
              <li><a class="dropdown-item" href="financial-assistance.html">Financial Assistance</a></li>
              <li><a class="dropdown-item" href="post-admission-services.html">Post Admission Services</a></li>
              <li><a class="dropdown-item" href="visa-services.html">Visa Services</a></li>
              <li><a class="dropdown-item" href="scholarship.html">Scholarship</a></li>
              <li><a class="dropdown-item" href="get-started-now.html">Get Started Now</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="ireland.html">Ireland</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="pte.html">PTE</a></li>
              <li><a class="dropdown-item" href="oet.html">OET</a></li>
              <li><a class="dropdown-item" href="test-centers.html">Test Centers</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="our-associates-and-offices.html">Our Associates and Offices</a></li>
            </ul>
          </li>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="border p-5">
          <h2 class="text-center"><i class="bi bi-search"></i> Find Us</h2>
          <hr>
          <div class="text-center mt-4">
            <h3>Chandigarh</h3>
            <p class="lead">SCO 364-365-366, 2nd Floor, Sector 34-A, Chandigarh</p>
          </div>
          <div class="text-center mt-4">
            <h3>Srinagar</h3>
            <p class="lead">Room No 16-17, 2nd Floor, Old JKB, Zonal Office Building Karan Nagar, Srinagar -190010</p>
          </div>
          <div class="text-center mt-4">
            <h3>Shimla and Solan</h3>
            <p class="lead">Dev Shakti Kunj, North Oak, Sanjauli, Shimla -171006</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="border p-5">
          <h2 class="text-center"><i class="bi bi-clock"></i> Business Hours</h2>
          <hr>
          <div class="text-center mt-4">
            <p class="lead">Mon-Sat: 09:00–18:00</p>
            <p class="lead">Sun: Meeting on appointment</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="border p-5">
          <h2 class="text-center"><i class="bi bi-telephone"></i> Contact</h2>
          <hr>
          <div class="text-center mt-4">
            <!-- <h3><i class="bi bi-envelope"></i></h3> -->
            <!-- <a class="lead no-underline text-black text-start" href="mailto:info@sunupoverseas.com">info@sunupoverseas.com</a> -->
            <a title="info@sunupoverseas.com" class="btn btn-primary w-100" href="mailto:info@sunupoverseas.com"><i class="bi bi-envelope"></i> Email Us</a>
          </div>
          <div class="text-center mt-4">
            <!-- <h3><i class="bi bi-telephone"></i></h3> -->
            <!-- <a class="lead no-underline text-black" href="tel:+916280606005">+91-6280606005</a> -->
            <a title="+91-6280606005" class="btn btn-primary w-100" href="tel:+916280606005"><i class="bi bi-telephone"></i> Call Us</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- <div class="container text-center mt-5">
    <div class="row">
      <div class="col border p-3"><i class="bi bi-search"></i><h3>Find Us</h3></div>
      <div class="col border p-3"><h3>Chandigarh</h3> <p>SCO 364-365-366, 2nd Floor,
        Sector 34-A, Chandigarh</p></div>
      <div class="col border p-3"><h3>Srinagar</h3> <p>Room No 16-17, 2nd Floor, Old JKB, Zonal Office Building Karan Nagar, Srinagar -190010</p></div>
      <div class="col border p-3"><h3>Shimla and Solan</h3><p>Dev Shakti Kunj, North Oak , Sanjauli, Shimla -171006</p></div>
    </div>
  </div> -->
...
if (isset($_POST['send'])) {
  ...
  try {
    ...
    $mail->Username   = 'kamranriyaz2@gmail.com';                     //SMTP username
    $mail->Password   = 'lrkh clfi pgqx apja';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('kamranriyaz2@gmail.com', 'Sunwise - Contact Form');
